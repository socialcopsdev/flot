  ...
  function Plot(placeholder, data_, options_, plugins) {
    ...
    var series = [],
      options = {
        ...
        legend: {
          ...
          clickable: true // if true, on click shows/hides the corresponding pie.
        },
        xaxis: {
    ...
    function insertLegend() {
      ...
      for (var i = 0; i < entries.length; ++i) {
        ...
        fragments.push(
          '<td><div class="legendBox legendBox-' + i + '" style="min-width:100px;"><div class="legendColorBox" style="display:inline-block;width:9px;height:9px;border-radius:50%;background:' + entry.color + '"></div><div class="legendLabel" style="padding-left:5px;display:inline-block;">' + entry.label + '</div></div></td>'
        );
      }
